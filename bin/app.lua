...
TimingTests.log = function(v) 
  __haxe_Log.trace(v, _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=26,className="TimingTests",methodName="log"}));
end
TimingTests.clear = function() 
end
TimingTests.stressTestQueens = function(count) 
  __haxe_Log.trace(Std.string(Std.string("Running 8 Queens * ") .. Std.string(count)) .. Std.string(" ..."), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=41,className="TimingTests",methodName="stressTestQueens"}));
  local solutions = TimingTests.stressTest(TimingTests.queens_theory, "run_queens", count);
  if (count == 1) then 
    __haxe_Log.trace(Std.string("solution count = ") .. Std.string(solutions.length), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=44,className="TimingTests",methodName="stressTestQueens"}));
    local _g = 0;
    while (_g < solutions.length) do 
      local solution = solutions[_g];
      _g = _g + 1;
      __haxe_Log.trace(solution:toString(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=46,className="TimingTests",methodName="stressTestQueens"}));
    end;
  end;
end
TimingTests.stressTestOKeefeQueens = function(count) 
  __haxe_Log.trace(Std.string(Std.string("Running O'Keefe 8 Queens * ") .. Std.string(count)) .. Std.string(" ..."), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=52,className="TimingTests",methodName="stressTestOKeefeQueens"}));
  local solutions = TimingTests.stressTest(TimingTests.okeefe_queens_theory, "run_queens", count);
  if (count == 1) then 
    __haxe_Log.trace(Std.string("solution count = ") .. Std.string(solutions.length), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=55,className="TimingTests",methodName="stressTestOKeefeQueens"}));
    local _g = 0;
    while (_g < solutions.length) do 
      local solution = solutions[_g];
      _g = _g + 1;
      __haxe_Log.trace(solution:toString(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=57,className="TimingTests",methodName="stressTestOKeefeQueens"}));
    end;
  end;
end
TimingTests.stressTestZebra = function(count) 
  __haxe_Log.trace(Std.string(Std.string("Running Zebra * ") .. Std.string(count)) .. Std.string(" ..."), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=63,className="TimingTests",methodName="stressTestZebra"}));
...
TimingTests.stressTest = function(theory,predName,count) 
  ...
  __haxe_Log.trace(Std.string("Average time = ") .. Std.string(time / count), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=79,className="TimingTests",methodName="stressTest"}));
  do return solutions end;
end
TimingTests.main = function() 
  __haxe_Timer.delay(function() 
    __haxe_Log.trace("Starting....", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=112,className="TimingTests",methodName="main"}));
    local zebra = TimingTests.new(TimingTests.zebra_theory);
    local timestamp = Sys.time();
    local solutions = zebra:run("zebra");
    __haxe_Log.trace(Std.string(Std.string("Zebra in ") .. Std.string((Sys.time() - timestamp))) .. Std.string(" seconds"), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=116,className="TimingTests",methodName="main"}));
    __haxe_Log.trace(Std.string("solution count = ") .. Std.string(solutions.length), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=117,className="TimingTests",methodName="main"}));
    local _g = 0;
    while (_g < solutions.length) do 
      local solution = solutions[_g];
      _g = _g + 1;
      __haxe_Log.trace(solution:toString(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=119,className="TimingTests",methodName="main"}));
    end;
    ...
    __haxe_Log.trace(Std.string(Std.string("8 queens in ") .. Std.string((Sys.time() - timestamp))) .. Std.string(" seconds"), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=128,className="TimingTests",methodName="main"}));
    __haxe_Log.trace(Std.string("solution count = ") .. Std.string(solutions.length), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=129,className="TimingTests",methodName="main"}));
    local _g = 0;
    while (_g < solutions.length) do 
      local solution = solutions[_g];
      _g = _g + 1;
      __haxe_Log.trace(solution:toString(), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/TimingTests.hx",lineNumber=134,className="TimingTests",methodName="main"}));
    end;
  end, 500);
end
