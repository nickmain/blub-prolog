...
class TimingTests:
    ...
    @staticmethod
    def log(v):
        haxe_Log.trace(v,_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 26, 'className': "TimingTests", 'methodName': "log"}))
    ...
    def stressTestQueens(count):
        haxe_Log.trace((("Running 8 Queens * " + Std.string(count)) + " ..."),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 41, 'className': "TimingTests", 'methodName': "stressTestQueens"}))
        solutions = TimingTests.stressTest(TimingTests.queens_theory,"run_queens",count)
        if (count == 1):
            haxe_Log.trace(("solution count = " + Std.string(len(solutions))),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 44, 'className': "TimingTests", 'methodName': "stressTestQueens"}))
            _g = 0
            while (_g < len(solutions)):
                solution = (solutions[_g] if _g >= 0 and _g < len(solutions) else None)
                _g = (_g + 1)
                haxe_Log.trace(solution.toString(),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 46, 'className': "TimingTests", 'methodName': "stressTestQueens"}))

    @staticmethod
    def stressTestOKeefeQueens(count):
        haxe_Log.trace((("Running O'Keefe 8 Queens * " + Std.string(count)) + " ..."),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 52, 'className': "TimingTests", 'methodName': "stressTestOKeefeQueens"}))
        solutions = TimingTests.stressTest(TimingTests.okeefe_queens_theory,"run_queens",count)
        if (count == 1):
            haxe_Log.trace(("solution count = " + Std.string(len(solutions))),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 55, 'className': "TimingTests", 'methodName': "stressTestOKeefeQueens"}))
            _g = 0
            while (_g < len(solutions)):
                solution = (solutions[_g] if _g >= 0 and _g < len(solutions) else None)
                _g = (_g + 1)
                haxe_Log.trace(solution.toString(),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 57, 'className': "TimingTests", 'methodName': "stressTestOKeefeQueens"}))

    @staticmethod
    def stressTestZebra(count):
        haxe_Log.trace((("Running Zebra * " + Std.string(count)) + " ..."),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 63, 'className': "TimingTests", 'methodName': "stressTestZebra"}))
    ...
    def stressTest(theory,predName,count):
        ...
        haxe_Log.trace(("Average time = " + Std.string(((time / count)))),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 79, 'className': "TimingTests", 'methodName': "stressTest"}))
        return solutions

    @staticmethod
    def main():
        def _hx_local_2():
            haxe_Log.trace("Starting....",_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 112, 'className': "TimingTests", 'methodName': "main"}))
            zebra = TimingTests(TimingTests.zebra_theory)
            timestamp = python_lib_Timeit.default_timer()
            solutions = zebra.run("zebra")
            haxe_Log.trace((("Zebra in " + Std.string(((python_lib_Timeit.default_timer() - timestamp)))) + " seconds"),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 116, 'className': "TimingTests", 'methodName': "main"}))
            haxe_Log.trace(("solution count = " + Std.string(len(solutions))),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 117, 'className': "TimingTests", 'methodName': "main"}))
            _g = 0
            while (_g < len(solutions)):
                solution = (solutions[_g] if _g >= 0 and _g < len(solutions) else None)
                _g = (_g + 1)
                haxe_Log.trace(solution.toString(),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 119, 'className': "TimingTests", 'methodName': "main"}))
            TimingTests.stressTestOKeefeQueens(10)
            queens = TimingTests(TimingTests.queens_theory)
            timestamp = python_lib_Timeit.default_timer()
            solutions = queens.run("run_queens")
            haxe_Log.trace((("8 queens in " + Std.string(((python_lib_Timeit.default_timer() - timestamp)))) + " seconds"),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 128, 'className': "TimingTests", 'methodName': "main"}))
            haxe_Log.trace(("solution count = " + Std.string(len(solutions))),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 129, 'className': "TimingTests", 'methodName': "main"}))
            _g = 0
            while (_g < len(solutions)):
                solution = (solutions[_g] if _g >= 0 and _g < len(solutions) else None)
                _g = (_g + 1)
                haxe_Log.trace(solution.toString(),_hx_AnonObject({'fileName': "src/TimingTests.hx", 'lineNumber': 134, 'className': "TimingTests", 'methodName': "main"}))
