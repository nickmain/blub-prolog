...
Math.__name__ = "Math";
var Prolog = $hx_exports["Prolog"] = function(theory) {
	this.db = new blub_prolog_Database();
	this.db.loadString(theory,true);
};
$hxClasses["Prolog"] = Prolog;
Prolog.__name__ = "Prolog";
Prolog.main = function() {
};
Prolog.prototype = {
	db: null
	,query: function(queryTerm,resultVarName) {
		var q = this.db.query(queryTerm);
		...
		while(_g < results.length) {
			...
			++_g;
			var binding = result.h[resultVarName];
			if(binding != null) {
				values.push(binding.asAtom().text);
			}
		}
		return values;
	}
