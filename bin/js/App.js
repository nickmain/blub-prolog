...
TimingTests.log = function(v) {
	haxe_Log.trace(v,{ fileName : "src/TimingTests.hx", lineNumber : 32, className : "TimingTests", methodName : "log"});
};
...
TimingTests.stressTestQueens = function(count) {
	haxe_Log.trace("Running 8 Queens * " + count + " ...",{ fileName : "src/TimingTests.hx", lineNumber : 47, className : "TimingTests", methodName : "stressTestQueens"});
	var solutions = TimingTests.stressTest(TimingTests.queens_theory,"run_queens",count);
	if(count == 1) {
		haxe_Log.trace("solution count = " + solutions.length,{ fileName : "src/TimingTests.hx", lineNumber : 50, className : "TimingTests", methodName : "stressTestQueens"});
		var _g = 0;
		while(_g < solutions.length) {
			var solution = solutions[_g];
			++_g;
			haxe_Log.trace(solution.toString(),{ fileName : "src/TimingTests.hx", lineNumber : 52, className : "TimingTests", methodName : "stressTestQueens"});
		}
	}
};
